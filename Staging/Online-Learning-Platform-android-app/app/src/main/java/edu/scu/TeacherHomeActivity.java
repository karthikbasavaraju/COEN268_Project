...
import edu.scu.students.HomeFragment;
import edu.scu.students.ScheduleFragment;
import edu.scu.teachers.T_AddCourseActivity;
import edu.scu.teachers.T_HomeFragment;
...
public class TeacherHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(IISightSDKManager.getInstance().isLoggedIn(getApplicationContext()))
            Toast.makeText(this, "11Sight Logged In", Toast.LENGTH_SHORT).show();
